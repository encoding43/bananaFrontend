...
import SheduleFarmers from './../pages/SheduleFarmers';
...
import CompanyBil from '../pages/CompanyBill';
import FarmerBill from '../pages/FamerBill';
import LabourBill from '../pages/LabourBill';
import Company from '../pages/company';
import PackingMaterial from '../pages/packingMaterial/PackingMaterial';
import EmptyBox from '../pages/emptyBoxes';
import InventColdStorage from '../pages/inventoryColdStorage';
import Party from '../pages/ColdStoragePages/Party';
import TruckWeight from '../pages/transport/TruckWeight';
import LabourPickup from '../pages/pickupDaily/LabourPickup';
import TransportPaymet from '../pages/transport/TransportPayment';
