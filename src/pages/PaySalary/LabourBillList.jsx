...
export default function LabourBillList({ openAddModal, setOpenAddModal, party }) {
  ...
  Cell: ({ cell }) => cell.getValue() || 'N/A',
    ...
    // {
    //     accessorKey: 'unloadingCharges',
    //     header: 'Box unloading charges',
    //     size: 200,
    //     enableColumnActions: false,
    // enableSorting: false,
    // Cell: ({ cell }) => cell.getValue() || 'N/A',
    ...
    Cell: ({ cell }) => (
      <>
        ...
        {console.log('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa  ',cell?.row?.original?.box?.[0]?.emptyBoxWeight)}
      </>
    ),
    },
    // {
  ...
  return (
    <Dialog open={openAddModal} onClose={handleClose} fullWidth={true} maxWidth={'lg'}>
