...
const SignIn: React.FC = () => {
  ...
  const [mobile, setMobileNo] = useState<string>("")
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      const res = await postAPI("/user/login", { mobile, password, type });
      ...
      toast.error("Login failed. Please check your mobile number and password.");
    } finally {
      setLoading(false);
    }
  };
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4" onClick={() => setIsPasswordShow(!ispasswordshow)}>
                      {/* <svg
                        className="fill-current"
                        width="22"
                        height="22"
                      ...
                      {
                        !ispasswordshow ? <IoEyeSharp /> : <FaEyeSlash />
                      }
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-5">
                  ...
                  <button
                    ...
                    className={`w-full cursor-pointer rounded-lg border border-primary p-4 text-white transition 
                     ${loading ? 'bg-opacity-90 bg-gray-400' : 'bg-primary hover:bg-opacity-90'}`}
